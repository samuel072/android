...
public class MediaController extends FrameLayout implements
	...
	private ImageButton mPauseButton, mBackButton, mLockButton, mKuodaButton,
			mNextButton;
	private RadioGroup radioGroup;
	private Button tv_biaoqing;
	...
	protected void onConfigurationChanged(Configuration newConfig) {
		...
		full(getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE);
	 ...
	 * @param b
	 */
	private void full(boolean toland) {
		// TODO Auto-generated method stub
		if (toland) {
			rl_play_kongjian.setVisibility(View.VISIBLE);
			tv_biaoqing.setVisibility(0);
			//mKuodaButton.setImageResource(R.drawable.icon_07bofang_suoxiao);
		} else {
			rl_play_kongjian.setVisibility(View.GONE);
			tv_biaoqing.setVisibility(8);
	...
	private LinearLayout rl_play_kongjian;
	...
	private void initControllerView(View v) {
		...
		mKuodaButton = (ImageButton) v.findViewById(getResources()
				.getIdentifier("img_paly_fangda", "id",
						mContext.getPackageName()));
		...
		rl_play_kongjian = (LinearLayout) v.findViewById(R.id.rl_play_kongjian);
		v.findViewById(R.id.ImageButton7).setOnClickListener(
				new OnClickListener() {
		...
		v.findViewById(R.id.ImageButton6).setOnClickListener(
				new OnClickListener() {
		...
		v.findViewById(R.id.ImageButton5).setOnClickListener(
				new OnClickListener() {
		...
		mCurrentTime = (TextView) v.findViewById(getResources().getIdentifier(
				"tv_video_time", "id", mContext.getPackageName()));
		mFileName = (TextView) v.findViewById(getResources().getIdentifier(
				"tv_video_titles", "id", mContext.getPackageName()));
		// if (mFileName != null)
		// mFileName.setText(mTitle);

		tv_biaoqing = (Button) findViewById(R.id.btn_biaoqing);
		radioGroup = (RadioGroup) findViewById(R.id.rg_play);
	...
	public void onCheckedChanged(RadioGroup group, int checkedId) {
		switch (checkedId) {
		case R.id.rb_biaoqing:
			tv_biaoqing.setText(R.string.biaoqing);
			break;
		case R.id.rb_chaoqing:
			tv_biaoqing.setText(R.string.chaoqing);
			break;
		case R.id.rb_gaoqing:
			tv_biaoqing.setText(R.string.gaoqing);
			break;
		default:
			break;
		}
