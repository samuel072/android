...
public class PullToRefreshListView extends
	...
	public void onRefreshing(final boolean doScroll,Mode mode) {
		setCurrentMode(mode);
		onRefreshing(doScroll);
	}
	@Override
	...
	public int getHeaderLoadingViewHeight() {
		return mHeaderLoadingView.getHeight();
	}
